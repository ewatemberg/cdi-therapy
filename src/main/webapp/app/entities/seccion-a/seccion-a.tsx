...
import { getEntities } from './seccion-a.reducer';
import { ISeccionA } from 'app/shared/model/seccion-a.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';
import { overridePaginationStateWithQueryParams } from 'app/shared/util/entity-utils';

export interface ISeccionAProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}
        ...
        {seccionAList && seccionAList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('chequeado')}>
                  <Translate contentKey="cdiApp.seccionA.chequeado">Chequeado</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {seccionAList.map((seccionA, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{seccionA.descripcion}</td>
                  <td>{seccionA.chequeado ? 'true' : 'false'}</td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="cdiApp.seccionA.home.notFound">No Seccion AS found</Translate>
            </div>
          )
        )}
      </div>
      {props.totalItems ? (
        <div className={seccionAList && seccionAList.length > 0 ? '' : 'd-none'}>
...
const mapStateToProps = ({ seccionA }: IRootState) => ({
  seccionAList: seccionA.entities,
  loading: seccionA.loading,
  totalItems: seccionA.totalItems,
});
...
export default connect(mapStateToProps, mapDispatchToProps)(SeccionA);

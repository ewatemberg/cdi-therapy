...
export const CuestionarioDetail = (props: ICuestionarioDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="cdiApp.cuestionario.detail.title">Cuestionario</Translate> [<b>{cuestionarioEntity.id}</b>]
        </h2>
        ...
        <Button tag={Link} to="/cuestionario" replace color="info">

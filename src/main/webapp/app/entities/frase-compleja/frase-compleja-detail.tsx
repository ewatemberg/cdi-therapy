...
export const FraseComplejaDetail = (props: IFraseComplejaDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        &nbsp;
        <Button tag={Link} to={`/frase-compleja/${fraseComplejaEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(FraseComplejaDetail);

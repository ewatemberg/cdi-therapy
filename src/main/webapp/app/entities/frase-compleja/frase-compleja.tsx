...
export const FraseCompleja = (props: IFraseComplejaProps) => {
  ...
  return (
    <div>
      <h2 id="frase-compleja-heading" data-cy="FraseComplejaHeading">
        <Translate contentKey="cdiApp.fraseCompleja.home.title">Frase Complejas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="cdiApp.fraseCompleja.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {fraseComplejaList && fraseComplejaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="cdiApp.fraseCompleja.id">ID</Translate>
                </th>
                <th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`${match.url}/${fraseCompleja.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`${match.url}/${fraseCompleja.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${fraseCompleja.id}/delete`}
                        color="danger"
                        size="sm"

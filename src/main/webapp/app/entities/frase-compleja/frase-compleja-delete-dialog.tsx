...
export const FraseComplejaDeleteDialog = (props: IFraseComplejaDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="fraseComplejaDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-fraseCompleja" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
